...
var PhotoSlideshow = function(photoMap){
  ...
  var nextPhoto = function(cb){
    async.waterfall([
      ...
      photoMapUtil.pickRandomPhoto(photoArray, function(err, nextPhoto){
        photoMapUtil.markPhoto(photoMap, nextPhoto, function(err, newPhotoMap){
          lastPhotoId = nextPhoto.id;
